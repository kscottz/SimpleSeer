...
(function() {
  ...
  var cloneSkeleton, copySkeleton, create, exec, fs_utils, helpers, logger, mkdirp, removeAndInstall, rimraf, sysPath;
  ...
  removeAndInstall = function(rootPath, callback) {
  ...
  copySkeleton = function(skeletonPath, rootPath, callback) {
    ...
    copyDirectory = function(from) {
      return fs_utils.copyIfExists(from, rootPath, false, function(error) {
        ...
        return removeAndInstall(rootPath, callback);
      });
    };
  ...
  module.exports = create = function(options, callback) {
    ...
    re = /(?:https?|git(hub)?)(?::\/\/|@)/;
    return fs_utils.exists(rootPath, function(exists) {
